...
work; implement the remaining Authority and Key-Epoch event families beyond the authenticated
Administrator type-12 rotation; expose conflict/rebase and sparse-Replica state; and finish Wails

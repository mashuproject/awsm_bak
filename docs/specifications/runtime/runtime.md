...
projection, state-only Fork checkpointing, Client Credential ending, Storage Relief, Garbage Collection, Hosted Replica
...
closures. Remaining Authority and Key-Epoch event families beyond Client Credential ending and Administrator rotation, conflict/rebase projections, sparse-Replica state,

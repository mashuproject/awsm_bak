...
Client Credential ending, Administrator Key Epoch rotation, and encrypted
...
remaining Authority and Key-Epoch event families beyond Client Credential ending and authenticated Administrator rotation, conflict/rebase projections, and the remaining Wails

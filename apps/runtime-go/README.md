...
Closure, authenticated Membership and Client Credential ending, Key Envelope delivery, and Administrator Key Epoch rotation, Vacuum adoption, Library projection, authenticated Event/Object replay,
...
beyond Membership/Client Credential ending, Key Envelope delivery, and Administrator rotation, conflict/rebase projections, sparse-Replica state, and the remaining Wails workflow coverage beyond

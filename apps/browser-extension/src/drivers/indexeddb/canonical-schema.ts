...
export const NAMESPACES = {
  ...
  desktopRuntimeGrant: namespace({
    key: "awsm.storage.desktop-runtime-grant",
    family: STORAGE_FAMILIES.InstallationState,
    scope: "Installation",
    identity: "Singleton Desktop Runtime grant",
    trustSource: "Authenticated",
    protection: "InstallationWrapped",
    synchronization: "InstallationLocal",
    exportTreatment: "Excluded",
    backupTreatment: "Excluded",
    retention: "Until the user disconnects or the grant is revoked",
    deletion: "Explicit disconnect, invalid grant, or Storage Realm reset",
    transactionPartners: ["awsm.storage.installation-wrapping-key"],
    unknownBehavior: "FailClosed",
    immutable: false,
  }),
  replicaRemote: namespace({
    ...
    transactionPartners: [
      ...
      "awsm.storage.remote-materialization-ledger",
    ],
    unknownBehavior: "FailClosed",
    immutable: false,
  }),
  ...
  remoteMaterializationLedger: namespace({
    key: "awsm.storage.remote-materialization-ledger",
    family: STORAGE_FAMILIES.ExecutionState,
    scope: "Remote",
    identity: "Replica Remote and protected logical item identity",
    trustSource: "TrustedLocal",
    protection: "InstallationWrapped",
    synchronization: "Never",
    exportTreatment: "Excluded",
    backupTreatment: "Excluded",
    retention: "While the local Replica Remote remains configured",
    deletion: "Explicit local Remote removal after prepared-output disclosure",
    transactionPartners: ["awsm.storage.replica-remote", "awsm.storage.prepared-outgoing-item"],
    unknownBehavior: "FailClosed",
    immutable: false,
  }),
  ...
  preparedOutgoingItem: namespace({
    key: "awsm.storage.prepared-outgoing-item",
    family: STORAGE_FAMILIES.PreparedData,
    scope: "Remote",
    identity: "Replica Remote and prepared Opaque Storage Item ID",
    trustSource: "TrustedLocal",
    protection: "Opaque",
    synchronization: "Never",
    exportTreatment: "Excluded",
    backupTreatment: "Excluded",
    retention: "Until immutable Host admission is confirmed or the local Remote is removed",
    deletion: "After confirmation or explicit Remote removal",
    transactionPartners: ["awsm.storage.remote-materialization-ledger"],
    unknownBehavior: "FailClosed",
    immutable: true,
  }),

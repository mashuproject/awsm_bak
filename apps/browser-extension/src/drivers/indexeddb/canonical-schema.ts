...
export const NAMESPACES = {
  ...
  replicaRemote: namespace({
    key: "awsm.storage.replica-remote",
    family: STORAGE_FAMILIES.InstallationState,
    scope: "Vault",
    identity: "Random local Replica Remote ID",
    trustSource: "TrustedLocal",
    protection: "InstallationWrapped",
    synchronization: "InstallationLocal",
    exportTreatment: "Excluded",
    backupTreatment: "Excluded",
    retention: "Until a user removes the local Replica Remote configuration",
    deletion: "Explicit local Remote removal after pending-work disclosure",
    transactionPartners: [
      "awsm.storage.remote-channel-credential",
      "awsm.storage.pull-synchronization-job",
    ],
    unknownBehavior: "FailClosed",
    immutable: false,
  }),
  ...
  remoteChannelCredential: namespace({
    key: "awsm.storage.remote-channel-credential",
    family: STORAGE_FAMILIES.TrustedSecrets,
    scope: "Remote",
    identity: "Replica Remote Channel Authenticator",
    trustSource: "TrustedLocal",
    protection: "InstallationWrapped",
    synchronization: "Never",
    exportTreatment: "Excluded",
    backupTreatment: "Excluded",
    retention: "Until the local Replica Remote is removed or its credential is replaced",
    deletion: "Explicit local Remote credential replacement or removal",
    transactionPartners: ["awsm.storage.replica-remote", "awsm.storage.pull-synchronization-job"],
    unknownBehavior: "FailClosed",
    immutable: false,
  }),
  ...
  pullSynchronizationJob: namespace({
    key: "awsm.storage.pull-synchronization-job",
    family: STORAGE_FAMILIES.ExecutionState,
    scope: "Vault",
    identity: "Random local pull-synchronization Job ID",
    trustSource: "TrustedLocal",
    protection: "LocalClear",
    synchronization: "Never",
    exportTreatment: "Excluded",
    backupTreatment: "Excluded",
    retention: "Until terminal outcome and bounded local outcome retention",
    deletion: "After terminal outcome retention or explicit Remote removal",
    transactionPartners: [
      "awsm.storage.replica-state",
      "awsm.storage.replica-remote",
      "awsm.storage.incoming-quarantine",
    ],
    unknownBehavior: "FailClosed",
    immutable: false,
  }),
  ...
  pendingVaultCreation: namespace({
    key: "awsm.storage.pending-vault-creation",
    family: STORAGE_FAMILIES.PreparedData,
    scope: "Installation",
    identity: "Vault creation setup ID",
    trustSource: "TrustedLocal",
    protection: "InstallationWrapped",
    synchronization: "Never",
    exportTreatment: "Excluded",
    backupTreatment: "Excluded",
    retention: "Until the user confirms or cancels the new Vault creation",
    deletion: "Atomically with initial Vault activation or explicit cancellation",
    transactionPartners: ["awsm.storage.replica-state", "awsm.storage.vault-directory"],
    unknownBehavior: "FailClosed",
    immutable: false,
  }),

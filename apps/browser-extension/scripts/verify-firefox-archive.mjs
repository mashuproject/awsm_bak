...
const expectedPages = new Set(["library.html", "popup.html", "signup.html"]);
...
try {
  ...
  for (const name of names) {
    ...
    assert(
      /^(?:assets\/|chunks\/|manifest\.json|background\.js|(?:library|popup|signup)\.html|chunks\/[^/]+\.js|assets\/[^/]+\.css|icon-(?:16|32|48|128|512)\.png)$/u.test(
        name,
      ),
